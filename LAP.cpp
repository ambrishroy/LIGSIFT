...
double lap(int dim, double **assigncost, col *rowsol, row *colsol, double *u, double *v){
    /*
     Input:
     dim        - problem size
    ...
    row    i=0, imin=0, numfree = 0, prvnumfree=0, f=0, i0=0, k=0, freerow=0, *pred=0, *free=0;
    col    j=0, j1=0, j2=0, endofpath=0, last=0, low=0, up=0, *collist=0, *matches=0;
    double min=0, h=0, umin=0, usubmin=0, v2=0, *d=0;
    ...
    do{
        ...
        while (k < prvnumfree){
            ...
            for (j = 1; j < dim; j++){
                ...
                if(cnt > 500){h = assigncost[i][j] - v[j] + rand(0,1);}
                if (h < usubmin){
                    if (h >= umin){
                        usubmin = h;
                        j2 = j;
...
void checklap(int dim, double **assigncost, col *rowsol, row *colsol, double *u, double *v){
    row  i=0;
    col  j=0;
    double  redcost = 0;
    bool *matched;
